...
interface UserTemplate1PDFProps {
  resumeData: ResumeState["resumeData"];
}

const UserTemplate1PDF = ({ resumeData }: UserTemplate1PDFProps) => {
      ...
      <Page size="A4" style={template1Styles.page}>
        ...
        <View style={template1Styles.aside}>
          ...
          {(resumeData.number || resumeData.email || resumeData.location) && (
            <View style={template1Styles.section}>
              <Text style={[template1Styles.sectionTitle, { color: "#fff" }]}>Contact</Text>
              {resumeData.number && (
            ...
            <View style={template1Styles.section}>
              ...
              {resumeData.websites.map((web, idx) => (
                <Link
                  key={idx}
                  src={web.trim()}
                  style={[template1Styles.listItem, template1Styles.link]}
                >
          ...
          {/* Additional sections for user-created resumes */}
        ...
        <View style={template1Styles.footer}>
          <Link src="https://github.com/HadiqaGohar/">
            <Text>User Template 1 - Powered by Hadiqa Gohar</Text>
          </Link>
        </View>
      </Page>
    </Document>
...
export default UserTemplate1PDF;