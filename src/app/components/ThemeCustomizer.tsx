...
const ThemeCustomizer: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-2 sm:p-4">
      <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2 sm:mb-4 flex items-center">
        <FiDroplet className="mr-1 sm:mr-2" />
        Customize Your Resume
      </h3>
        ...
        {sections.map((section) => {
          ...
          return (
            <button
              key={section.id}
              onClick={() => setActiveSection(section.id)}
              className={`flex items-center px-2 sm:px-3 py-1 sm:py-2 rounded-lg transition-all duration-300 ${
                activeSection === section.id
                  ? "bg-purple-600 text-white"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              } text-xs sm:text-sm`}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-2">
              {themes.map((theme, index) => (
                <button
                  key={index}
                  onClick={() => applyTheme(theme)}
                  className="p-1 sm:p-2 border border-gray-200 rounded-lg hover:border-purple-400 transition-colors group"
                >
                  ...
                  <p className="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-purple-600">
                    {theme.name}
                  </p>
                </button>
              ))}
            ...
            <div className="grid grid-cols-8 gap-1 sm:gap-2">
              {predefinedColors.map((color, index) => (
                <button
                  key={index}
                  onClick={() => handleColorSelect(color)}
                  className={`w-6 sm:w-10 h-6 sm:h-10 rounded-full border border-gray-300 transition-transform hover:scale-110 ${
                    resumeData.headerColor === color
                      ? "border-gray-800 ring-2 ring-purple-400"
                      : ""
                  }`}
          ...
          <div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              <input
                ...
                value={resumeData.headerColor || "#3b82f6"}
                onChange={(e) => handleColorSelect(e.target.value)}
                className="w-8 sm:w-12 h-8 sm:h-12 rounded-lg border border-gray-300 cursor-pointer"
              />
              <input
                type="text"
                value={customColor || resumeData.headerColor || ""}
                onChange={handleCustomColorChange}
                placeholder="#3b82f6"
                className="flex-1 px-1 sm:px-2 py-1 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-xs sm:text-sm"
              />
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2">
              <div>
                ...
                <select
                  ...
                  className="w-full p-1 sm:p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 text-xs sm:text-sm"
                >
                  {fontStyles.map((style) => (
                    <option key={style} value={style}>
                      {style.charAt(0).toUpperCase() +
      ...
      {activeSection === "image" && (
        <div className="space-y-2 sm:space-y-4">
            ...
            {resumeData.profileImage ? (
              <div className="text-center">
                <Image
                  src={resumeData.profileImage}
                  alt="Profile Preview"
                  className="w-20 sm:w-32 h-20 sm:h-32 rounded-full mx-auto mb-1 sm:mb-2 object-cover border-2 sm:border-4"
                  width={80} // Reduced from 128
                  height={80} // Reduced from 128
                  style={{ borderColor: resumeData.headerColor || "#3b82f6" }}
                />
                <div className="space-x-1 sm:space-x-2">
                  <label className="inline-flex items-center px-2 sm:px-4 py-1 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer transition-colors text-xs sm:text-sm">
                    <FiImage className="w-3 sm:w-4 h-3 sm:h-4 mr-1" />
                    Change Picture
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  <button
                    onClick={removeImage}
                    className="px-2 sm:px-4 py-1 sm:py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-xs sm:text-sm"
                  >
                    Remove Picture
                  </button>
                </div>
              ...
              <div className="text-center">
                <div className="w-20 sm:w-32 h-20 sm:h-32 rounded-full mx-auto mb-1 sm:mb-2 bg-gray-200 flex items-center justify-center border-2 sm:border-4 border-dashed border-gray-400">
                  <FiImage className="w-6 sm:w-12 h-6 sm:h-12 text-gray-400" />
                </div>
                <label className="inline-flex items-center px-2 sm:px-4 py-1 sm:py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 cursor-pointer transition-all duration-300 text-xs sm:text-sm">
                  <FiImage className="w-3 sm:w-5 h-3 sm:h-5 mr-1" />
                  Upload Profile Picture
                  <input
                    type="file"
                    accept="image/*"
          ...
          <div className="bg-gray-50 rounded-lg p-1 sm:p-2">
            <h5 className="font-semibold text-gray-800 mb-1 sm:mb-2 text-xs sm:text-sm">
              Tips for Great Profile Pictures:
            </h5>
        ...
        <div className="space-y-2 sm:space-y-4">
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-1 sm:p-2">
              ...
              <ul className="text-xs sm:text-sm text-gray-600 space-y-1">
                <li className="flex items-center">
                  <div className="w-1 sm:w-2 h-1 sm:h-2 bg-purple-500 rounded-full mr-1 sm:mr-2"></div>
                  Layout variations and spacing options
                </li>
                <li className="flex items-center">
                  <div className="w-1 sm:w-2 h-1 sm:h-2 bg-blue-500 rounded-full mr-1 sm:mr-2"></div>
                  Section reordering and visibility controls
                </li>
                <li className="flex items-center">
                  <div className="w-1 sm:w-2 h-1 sm:h-2 bg-green-500 rounded-full mr-1 sm:mr-2"></div>
                  Custom CSS styling options
                </li>
                <li className="flex items-center">
                  <div className="w-1 sm:w-2 h-1 sm:h-2 bg-yellow-500 rounded-full mr-1 sm:mr-2"></div>
                  Export format preferences
                </li>
              </ul>
            </div>
          ...
          <div>
            ...
            <div className="space-y-1 sm:space-y-2">
              <button
                onClick={() => setResumeData({ headerColor: "#3b82f6" })}
                className="w-full px-2 sm:px-4 py-1 sm:py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors text-xs sm:text-sm"
              >
                Reset Colors to Default
              </button>
              <button
                ...
                className="w-full px-2 sm:px-4 py-1 sm:py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-xs sm:text-sm"
              >
                Reset Typography to Default
              </button>
            </div>
