...
const ResumePreview: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      {/* Action Buttons */}
      <div className="bg-gray-50 px-2 sm:px-4 py-1 sm:py-2 border-b flex flex-col sm:flex-row justify-between items-center">
      ...
      <div className="template-preview-container relative">
        {/* Preview Container with Print-like Styling */}
        <div className="preview-wrapper bg-gray-100 p-1 sm:p-2">
          <div
            className="resume-page bg-white shadow-2xl mx-auto"
            style={{
              width: "8.5in",
        ...
        <div className="fixed bottom-1 sm:bottom-2 right-1 sm:right-2 z-50 print-hidden">
          <button
            onClick={handleEdit}
            className="flex items-center px-2 sm:px-3 py-1 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full shadow-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 text-xs"
            title="Quick Edit"
          >
            <FiEdit3 className="w-3 sm:w-4 h-3 sm:h-4 mr-1" />
            Quick Edit
