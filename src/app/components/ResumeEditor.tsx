  ...
  return (
    <div className="max-w-4xl mx-auto p-3 sm:p-6 bg-white rounded-xl shadow-lg">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Edit Resume</h2>
        {showSaveButton && (
          <button
            onClick={handleSave}
            className="mt-2 sm:mt-0 flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
        <div className="space-y-4 sm:space-y-6">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-800 border-b border-gray-200 pb-1 sm:pb-2">
            Personal Information
          </h3>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700 mb-1 sm:mb-2">
                <FiUser className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Full Name
              </label>
              <input
                type="text"
                ...
                onChange={handleInputChange("name")}
                placeholder="Enter your full name"
                className="w-full px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-xs sm:text-sm"
              />
            </div>

            <div>
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700 mb-1 sm:mb-2">
                <FiBriefcase className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Professional Title
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700 mb-1 sm:mb-2">
                <FiMail className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Email Address
              </label>
              <input
                type="email"
            ...
            <div>
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700 mb-1 sm:mb-2">
                <FiPhone className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Phone Number
              </label>
              <input
                type="tel"
            ...
            <div>
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700 mb-1 sm:mb-2">
                <FiMapPin className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Location
              </label>
              <input
                type="text"
          ...
          <div>
            <div className="flex items-center justify-between mb-1 sm:mb-2">
              ...
              <button
                onClick={generateSummary}
                disabled={isGeneratingSummary}
                className="flex items-center px-2 sm:px-3 py-1 text-xs sm:text-sm bg-purple-100 text-purple-700 rounded-full hover:bg-purple-200 transition-colors disabled:opacity-50"
              >
                <FiRefreshCw
            ...
            <textarea
              ...
              placeholder="Write a compelling professional summary..."
              rows={3}
              className="w-full px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-xs sm:text-sm"
            />
          </div>
        </div>
      </div>

      <div className="mt-4 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
        <div className="space-y-4 sm:space-y-6">
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between">
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700">
                <FiGlobe className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Websites & Links
              </label>
              <button
                type="button"
                onClick={addArrayItem("websites")}
                className="flex items-center px-2 sm:px-3 py-1 text-xs sm:text-sm bg-blue-100 text-blue-700 rounded-full hover:bg-blue-200 transition-colors"
              >
                <FiPlus className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
                Add
              </button>
            </div>
              ...
              {websitesArray.map((item, index) => (
                ...
                >
                  <input
                    ...
                    onChange={handleArrayChange("websites", index)}
                    placeholder="https://linkedin.com/in/yourname"
                    className="flex-1 px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-xs sm:text-sm"
                    autoComplete="off"
                  />
                  {websitesArray.length > 1 && (
                    <button
                      ...
                      title="Remove item"
                    >
                      <FiX className="w-3 sm:w-4 h-3 sm:h-4" />
                    </button>
                  )}
                </div>
              ))}
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between">
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700">
                <FiAward className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Skills
              </label>
              <div className="flex space-x-1 sm:space-x-2">
                ...
                <button
                  onClick={suggestSkills}
                  disabled={isSuggestingSkills}
                  className="flex items-center px-2 sm:px-3 py-1 text-xs sm:text-sm bg-green-100 text-green-700 rounded-full hover:bg-green-200 transition-colors disabled:opacity-50"
                >
                  <FiRefreshCw
                    className={`w-3 h-3 sm:w-4 sm:h-4 mr-1 ${
                      isSuggestingSkills ? "animate-spin" : ""
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between">
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700">
                <FiBook className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Education
              </label>
              <button
                type="button"
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between">
              <label className="flex items-center text-xs sm:text-sm font-semibold text-gray-700">
                <FiHeart className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2" />
                Extracurricular Activities
              </label>
              <button
                type="button"
