    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <div className="flex items-center w-full sm:w-auto">
                <div className="w-20 sm:w-32 bg-gray-200 rounded-full h-1.5 sm:h-2 mr-2 sm:mr-3">
                  <div
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <button className="flex items-center px-2 sm:px-4 py-1 sm:py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 text-xs sm:text-sm transition-colors">
                  <FiEye className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                  Preview
                </button>
                <button
                  onClick={handleDownload}
                  className="flex items-center px-2 sm:px-4 py-1 sm:py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 text-xs sm:text-sm"
                >
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex flex-wrap gap-4 sm:gap-8 py-2">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id)}
                  className={`flex items-center py-1 px-2 sm:px-1 border-b-2 font-medium text-xs sm:text-sm transition-colors ${
                    activeTab === tab.id
                      ? "border-blue-500 text-blue-600"
                      : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                  }`}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Template Selection Info */}
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-4 sm:p-6 mb-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 sm:w-12 sm:h-12 bg-purple-100 rounded-full flex items-center justify-center">
                <FiEye className="w-4 h-4 sm:w-6 sm:h-6 text-purple-600" />
              </div>
              <div>
            ...
            <div className="flex gap-2">
              <button
                onClick={() => setActiveTab("edit")}
                className="px-2 sm:px-4 py-1 sm:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center text-xs sm:text-sm"
              >
              ...
              <Link
                href="/template"
                className="px-2 sm:px-4 py-1 sm:py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-xs sm:text-sm"
              >
                Change Template
              </Link>
            </div>
      ...
      {resumeData.name && (
        <div className="fixed bottom-4 right-4 bg-white rounded-lg shadow-lg p-2 sm:p-4 border">
          <div className="text-xs sm:text-sm text-gray-600 mb-1">Quick Stats</div>
