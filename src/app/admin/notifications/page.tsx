...
export default function NotificationsAdmin() {
  ...
  const fetchSubscribers = async () => {
    try {
      ...
      console.error("Error fetching subscribers:", error);
      toast.error("Failed to fetch subscribers. Check console for details.");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-2 sm:p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4 text-sm text-gray-500 mb-4 sm:mb-6">
            <div className="flex items-center">
              <FiUsers className="mr-1 text-purple-500" />
              Subscriber Management
            </div>
          ...
          <div className="w-16 sm:w-24 h-0.5 sm:h-1 bg-gradient-to-r from-purple-500 to-blue-600 mx-auto rounded-full mb-6 sm:mb-8"></div>
        ...
        {/* Actions */}
        <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg mb-6 sm:mb-8 border border-white/20">
          <div className="p-2 sm:p-4 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <h2 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-2 sm:mb-0">
                Subscriber List
        ...
        {/* Instructions */}
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-dashed border-blue-300 rounded-lg sm:rounded-2xl p-2 sm:p-4 mt-6 sm:mt-8">
          <h3 className="text-base sm:text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2 sm:mb-3">
            📧 How to Send Notifications
          </h3>
          <div className="text-gray-700 space-y-1 sm:space-y-2 text-sm sm:text-base">
