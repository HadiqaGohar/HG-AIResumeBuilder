...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 px-2 sm:px-4 lg:px-8 py-4 sm:py-8 font-sans">
      <div className="max-w-4xl mx-auto">
        {/* Header Section */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
        ...
        >
          ...
          <h2 className="text-2xl sm:text-4xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600 mt-2 sm:mt-4">
            We Value Your Trust
          </h2>
        ...
        >
          <section className="hover:bg-gray-50 p-2 sm:p-3 rounded-lg transition-colors duration-200">
            <h2 className="text-xl sm:text-2xl font-semibold text-purple-700 mb-1 sm:mb-2">
              1. Information We Collect
            </h2>
