    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 py-4 sm:py-8 px-2 sm:px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-4 sm:mb-6">
          <div className="w-12 sm:w-16 h-12 sm:h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-4">
            <FiHelpCircle className="w-5 sm:w-8 h-5 sm:h-8 text-white" />
          </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          {faqs.map((category, categoryIndex) => (
            <div key={categoryIndex} className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-purple-500 to-blue-500 px-4 sm:px-6 py-2 sm:py-3">
                <h2 className="text-lg sm:text-2xl font-bold text-white">{category.category}</h2>
              </div>
              ...
              <div className="divide-y divide-gray-200">
                {category.questions.map((faq, faqIndex) => {
                  ...
                  return (
                    <div key={faqIndex} className="p-2 sm:p-4">
                      <button
                        onClick={() => toggleItem(itemId)}
                        className="w-full flex justify-between items-center text-left focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 rounded-lg p-1 sm:p-2 -m-1 sm:-m-2"
                      >
                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 pr-2 sm:pr-4">
                          {faq.question}
                        </h3>
                        {isOpen ? (
                          <FiChevronUp className="w-4 sm:w-5 h-4 sm:h-5 text-purple-600 flex-shrink-0" />
                        ) : (
                          <FiChevronDown className="w-4 sm:w-5 h-4 sm:h-5 text-purple-600 flex-shrink-0" />
                        )}
                      </button>
                      
                      {isOpen && (
                        <div className="mt-2 sm:mt-3 text-gray-600 text-sm sm:text-base leading-relaxed">
                          {faq.answer}
                        </div>
                      )}
                    </div>
        ...
        {/* Contact Section */}
        <div className="mt-6 sm:mt-12 bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center">
            <Link 
              href="/contact"
              className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 text-xs sm:text-sm"
            >
            ...
            <button
              ...
              className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 border-2 border-purple-500 text-purple-600 rounded-lg hover:bg-purple-500 hover:text-white transition-all duration-300 text-xs sm:text-sm"
            >
              <FiMessageCircle className="mr-1 sm:mr-2" />
              Chat with AI Assistant
            </button>
          </div>
        </div>
        ...
        {/* Creator Credit */}
        <div className="text-center mt-6 sm:mt-12 pt-4 sm:pt-6 border-t border-gray-200">
