    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-4 sm:p-6 md:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Advanced Filters and Controls */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-lg md:shadow-xl p-4 md:p-6 mb-6 md:mb-8 border border-white/20 relative z-10">
            <div className="flex flex-col space-y-4">
              {/* Search Bar */}
              <div className="relative">
                <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 md:gap-4">
                  <div className="relative z-20">
                    <select
                      ...
                      className="px-3 py-2 border border-gray-200 rounded-lg text-xs md:text-sm w-full appearance-none bg-white"
                    >
