...
//           </div>
//           {/* <h2 className="text-sm font-bold text-purple-600 uppercase tracking-wider">Resume Builder Support</h2> */}
...
//                 // className="w-full p-3 border border-gray-200 rounded-lg bg-gray-50 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200"
//                 className="w-full p-3 border-b focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200"
//                 required
//               />
//             </div>
...
//             <option value="TemplateInquiry">Template Inquiry</option>
...
//             <ul className="space-y-2 border border-gray-300 rounded-lg bg-gray-50 p-3">
//               <li className="cursor-pointer hover:bg-purple-100 p-2 rounded">
//                 Select a topic
//               </li>
//               <li className="cursor-pointer hover:bg-purple-100 p-2 rounded">
//                 Resume Review
