    ...
    <div className="bg-gradient-to-br from-purple-50 to-blue-50 min-h-screen flex items-center justify-center px-2 sm:px-4">
      <section className="max-w-3xl mx-auto p-2 sm:p-4 my-4 sm:my-8 bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl sm:rounded-2xl">
        ...
        <form
          action="https://api.web3forms.com/submit"
          method="POST"
          className="space-y-3 sm:space-y-6 p-2 sm:p-4 bg-white rounded-lg sm:rounded-xl"
        >
          <input
            type="hidden"
            name="access_key"
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-2 sm:py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transform hover:scale-105 transition duration-300 shadow-md text-xs sm:text-sm"
          >
            Send Message
          </button>
        </form>
